...
I'm going to show you how to use **datapasta** but only because I'm assuming you'll go back and bring the data in correctly later on as you're addind documentation to your project.

**Note:** What is `tribble()`? It's a new package that lets you build dataframes in a more human-readable way. [Check out tibble](https://cran.r-project.org/web/packages/tibble/vignettes/tibble.html).

**Another note:** Datapasta depends on keyboard shortcuts and using RStudio. That's why you'll see things magically appear in the GIF above without any clear commands. I'll explain below.
...
![Browse](images/datapasta1.png)

Next, click the **Keyboard Shortcuts** button.

![Browse](images/datapasta2.png)

Now, click add the keyboard shorts for each type of data you're creating in the  **Shortcuts** column.
...
Simple! Now assign that to an object and you can now clean up the column names and up by taking out commas, dollar signs, percent signs, etc, so you can do some analysis or visualization of the data.
